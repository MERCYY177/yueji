(()=>{
  ...
  const load=(src,done)=>{
    ...
    s.src=src+'?v=20260909-p0-resume5';
    s.onload=()=>{if(done)done()};
    s.onerror=()=>loaded.delete(src);
    document.head.appendChild(s);
  };
  load('yueji-weread-evidence.js',()=>load('yueji-fix-core.js',()=>load('yueji-layout.js',()=>load('yueji-book-cover.js',()=>load('yueji-onboarding.js',()=>load('yueji-p0-sync-guard.js',()=>load('yueji-p0-resume.js',()=>load('yueji-p0-failures.js',()=>load('yueji-p0-inflight.js',()=>load('yueji-p0-chain-test.js',()=>load('yueji-p0-auto-lock.js')))))))))));
})();
